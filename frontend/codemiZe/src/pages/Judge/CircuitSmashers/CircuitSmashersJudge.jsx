...
const CircuitSmashersJudge = () => {
  ...
  // Mock criteria for Circuit Smashers
  const mockCriteria = [
        ...
        <div className="text-gray-800 h-full">
          {gameStatus === 'waiting' ? (
            ...
            <div className="flex flex-col h-full">
              <div className="mb-4">
                <h2 className="text-2xl font-semibold">Circuit Smashers Marking</h2>
                <p className="text-gray-500 text-sm">Score each school's circuit submission based on the criteria below. Enter a number from 0-10 in each cell.</p>
              </div>

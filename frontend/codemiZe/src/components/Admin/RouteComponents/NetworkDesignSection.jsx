    ...
    <AdminBox width="flex-1 min-w-[300px]" minHeight="320px">
      <div className="flex flex-col space-y-4 mt-2">
        ...
        <div className="mt-3">
          ...
          <div className="justify-start text-black/80 text-base font-semibold font-['Inter']">Upload Responses</div>
          {/* Underline */}
          <img src="/under-line.png" alt="underline" className="w-full h-1" />

          <div className="flex items-center mt-3">
            <div className="justify-start text-black/60 text-xs font-medium font-['Inter']">Upload Response File</div>
            <div className="ml-2">
              <input
                type="file"
                id="responseFile"
              ...
              <label htmlFor="responseFile" className="cursor-pointer">
                <div className="w-11 h-5 bg-purple-800 rounded-sm flex items-center justify-center" onClick={handleResponseUpload}>
                  <FaUpload size={10} className="text-white" />
                </div>
              </label>
            </div>

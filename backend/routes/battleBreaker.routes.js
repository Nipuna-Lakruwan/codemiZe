...
import { addQuestion, addQuestionsCSV, buzzerPress, deleteAllQuestions, deleteQuestion, editQuestion, getDashboard, getQuestions, handleCompletion } from "../controllers/Games/battleBreakers.controller.js";
...
router.post("/finish", protect, requireAdmin, handleCompletion);
